...
const JobDetails = () => {
  ...
  const handleSubmit = async e => {
    ...
    // 1st deadline > 2nd deadline return 1;
    // 1st deadline < 2nd deadline return -1;
    // 1st deadline ==== 2nd deadline return 0;
    ...
    // 3. offered deadline is within seller deadline validation
    ...
    try {
      ...
      form.reset()
      toast.success('Confirm bid Successfully!');
      navigate('/my-bids');
    }
    catch (err) {
